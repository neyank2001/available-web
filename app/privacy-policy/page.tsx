...
export default function PrivacyPolicy() {
  ...
  return (
    <div className="font-sans bg-gradient-to-b from-gray-50 to-gray-200 text-gray-800 min-h-screen">
      {/* Main Content */}
      <main className="container mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <section className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-8 sm:p-12">
          ...
          <h2 className="text-2xl sm:text-3xl font-semibold mt-8 mb-4 text-gray-900">
            Interpretation and Definitions
          </h2>
          <h3 className="text-xl sm:text-2xl font-medium mt-6 mb-3 text-gray-800">
            Interpretation
          </h3>
          <p className="text-base sm:text-lg text-gray-700 mb-6">
          ...
          <ul className="list-disc pl-6 space-y-3 text-base sm:text-lg text-gray-700">
            ...
            <li>
              <strong>Website</strong> refers to Available, accessible from{" "}
              <a
          ...
          <h4 className="text-lg sm:text-xl font-medium mt-4 mb-2 text-gray-800">
            Personal Data
          </h4>
          <p className="text-base sm:text-lg text-gray-700 mb-4">
          ...
          <h4 className="text-lg sm:text-xl font-medium mt-6 mb-2 text-gray-800">
            Usage Data
          </h4>
          <p className="text-base sm:text-lg text-gray-700 mb-4">
          ...
          <ul className="list-disc pl-6 space-y-4 text-base sm:text-lg text-gray-700">
            <li>
              <p>
          ...
          <h3 className="text-xl sm:text-2xl font-medium mt-8 mb-3 text-gray-800">
          ...
          <ul className="list-disc pl-6 space-y-2 text-base sm:text-lg text-gray-700">
            <li className="flex items-center gap-2">
              <SafeFaEnvelope className="text-gray-600" />
              By email:{" "}
              <a
            ...
            <li className="flex items-center gap-2">
              <SafeFaGlobe className="text-gray-600" />
              By visiting this page on our website:{" "}
              <a
                href="http://availablehour.com/contact-us"
                rel="external nofollow noopener"
                target="_blank"
                className="text-gray-600 hover:text-gray-800 underline transition duration-200"
              >
                availablehour.com/contact-us
              </a>
            </li>
            <li className="flex items-center gap-2">
              <SafeFaPhone className="text-gray-600" />
              By phone number:{" "}
              <a
                href="#"
                className="text-gray-600 hover:text-gray-800 underline transition duration-200"
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-r from-black to-gray-700 text-white py-8">
